...
7. Compare the MLE estimator and the inverse of the sample coavriance matrix
---
...
- We computed the **MLE precision matrix** and compare it with the inverse of teh sample coavriance matrix 
